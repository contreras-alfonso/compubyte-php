...
<html lang="es">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo ">
        <h1 class="titulo_login"><?php echo $data['page_title']; ?></h1>
      </div>
      <div class="login-box">
              <div id="divLoading">
              <div>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtEmailReset" name="txtEmailReset" class="form-control" type="email" placeholder="Ejm: compubyte@gmail.com" >
          </div>
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>Reiniciar</button>
          </div>
          <div class="form-group mt-3">
            <p class="semibold-text mb-0"><a href="#" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i>Prefiero iniciar sesión</a></p>
          </div>
        </form>
      </div>
    </section>
