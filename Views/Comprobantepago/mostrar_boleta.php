...
<div class="cabecera">  
    ...
    <div class="titulo">
    <P class="negrita">BOLETA DE VENTA ELECTRONICA</P>
...
<p class="largowidth">DNI    <?php echo str_repeat('&nbsp;', 34); echo ": ";echo "<b>{$data['dni']}</b>"; ?></p>
...
<div class="tablita">
    <table CELLPADDING="10">
        ...
        <tr class="bordeTitulos">
            ...
            <td>UNIDAD</td>
            <td><?php echo $_SESSION['arrProductos'][$i]['codigo']; ?></td>
